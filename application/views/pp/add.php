<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('pp/add',array("class"=>"form-horizontal")); ?>

              	<div class="box-body">
                	<div class="form-group">
						<label for="nama_pp" class="col-md-4 control-label">Nama Pp</label>
						<div class="col-md-8">
							<input type="text" name="nama_pp" value="<?php echo $this->input->post('nama_pp'); ?>" class="form-control" id="nama_pp" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="jabat_pp" value="<?php echo $this->input->post('jabat_pp'); ?>" class="form-control" id="jabat_pp" />
						</div>
					</div>
					<div class="form-group">
						<label for="foto_pp" class="col-md-4 control-label">Foto Pp</label>
						<div class="col-md-8">
							<input type="text" name="foto_pp" value="<?php echo $this->input->post('foto_pp'); ?>" class="form-control" id="foto_pp" />
						</div>
					</div>
					<div class="form-group">
