            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo ($menu=="Laporan" ? "active treeview" : ""); ?>">
                          <a href="#">
                            <i class="fa fa-pie-chart"></i> <span>Laporan</span> <i class="fa fa-angle-left pull-right"></i>
                          </a>
                          <ul class="<?php echo ($submenu=="2016" ? "active treeview" : ""); ?>">
                            <li>
                                <a href="<?php echo site_url('program/index');?>">
                                    <i class="fa fa-area-chart"></i> <span>Tahun 2016</span>
                                </a>
                            </li>

                            <li class="<?php echo ($submenu=="2017" ? "active treeview" : ""); ?>">
                                <a href="#">
                                    <i class="fa fa-bar-chart"></i> <span>Tahun 2017</span> <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                <ul class="treeview-menu">
                                    <li>
                                        <a href="<?php echo site_url('laporan/index/2017');?>">
                                            <i class="fa fa-area-chart"></i> <span>Total Anggaran PD</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo site_url('laporan/index_btl/2017');?>">
                                            <i class="fa fa-area-chart"></i> <span>Belanja Tidak Langsung</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo site_url('laporan/index_bl/2017');?>">
                                            <i class="fa fa-area-chart"></i> <span>Belanja Langsung</span>
                                        </a>
                                    </li>     
                                    <li class="active">
                                        <a href="<?php echo site_url('laporan/index_pptk/2017');?>">
                                            <i class="fa fa-area-chart"></i> <span>Kinerja PPTK</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo site_url('laporan/index/2017');?>">
                                            <i class="fa fa-area-chart"></i> <span>Pengadaan Barang Jasa</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                          ...
                          <ul class="treeview-menu">
                            ...
                            <li class="active treeview">
                              ...
                              <ul class="treeview-menu">
                                ...
                                <li>
                                    <a href="<?php echo site_url('kegiatan/index/'.$program['kode_prog']);?>">
                                ...
                                <li>
                                    <a href="<?php echo site_url('belanja/index/'.$kegiatan['kode_giat']);?>">
