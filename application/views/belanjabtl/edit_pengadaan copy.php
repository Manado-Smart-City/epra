<div class="row">
    ...
    <div class="box">
        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <a href="<?php echo site_url('belanja/index2/'.$program['kode_prog']);?>" class="btn btn-primary btn-sm">Kembali ke Daftar Kegiatan</a>
            </div>
        </div><br>
               ...
               <div class="tab-content">
                  <div <?php echo (isset($tab_menu) && $tab_menu == "umum" ? 'class="tab-pane active"' : 'class="tab-pane" '); ?>" id="tab_1">
                      ...
                      <div class="col-md-5">
                        ...
                        <?php
                          if(!$belanja['file_dokumen_kak']=='') {
                            echo 'File yang telah terunggah: <a href="'.site_url('uploads/belanja/pengadaan/'.$belanja['file_dokumen_kak']).'">'.$belanja['file_dokumen_kak'].'</a>'; 
                          }                              
                        ?>                 
                      </div>
                    </div>  
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-md-3">
                             <input type="text" name="volume_belanja" value="<?php echo ($this->input->post('volume_belanja') ? $this->input->post('volume_belanja') : $belanja['volume_belanja']); ?>" class="form-control integer" id="volume_belanja" />
                  ...
                  <div <?php echo (isset($tab_menu) && $tab_menu == "penyediaan" ? 'class="tab-pane active" ' : 'class="tab-pane"'); ?> id="tab_2">
                      ...
                      <div class="form-group">
                           ...
                           <div class="col-md-3">
                              <div class="input-group">
                               ...
                               <input type="text" name="tanggal_kontrak" value="<?php echo ($this->input->post('tanggal_kontrak') ? $this->input->post('tanggal_kontrak') : $belanja['tanggal_kontrak']); ?>" class="form-control date" />
                      ...
                      <div class="form-group">
                           ...
                           <div class="input-group">
                               <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                               <input type="text" name="tanggal_mulai_kontrak" value="<?php echo ($this->input->post('tanggal_mulai_kontrak') ? $this->input->post('tanggal_mulai_kontrak') : $belanja['tanggal_mulai_kontrak']); ?>" class="form-control date" id="tanggal_mulai_kontrak" placeholder="dd/mm/yyy" />
                        ...
                        <div class="col-md-6">
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_1" value="<?php echo ($this->input->post('kf_1') ? $this->input->post('kf_1') : $belanja['kf_1']); ?>" class="form-control" id="kf_1"/>
                                      <?php echo form_error('kf_1'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_1" value="<?php echo ($this->input->post('kk_1') ? $this->input->post('kk_1') : $belanja['kk_1']); ?>" class="form-control" id="kk_1"/>
                                      <?php echo form_error('kk_1'); ?>
                                   </div>
                                </div> <!-- /.form-group -->
                             </div> <!-- /.panel-body -->
                          </div> <!-- /.panel -->
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_2" value="<?php echo ($this->input->post('kf_2') ? $this->input->post('kf_2') : $belanja['kf_2']); ?>" class="form-control" id="kf_2"/>
                                      <?php echo form_error('kf_2'); ?>
                                   </div><br><br>   
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_2" value="<?php echo ($this->input->post('kk_2') ? $this->input->post('kk_2') : $belanja['kk_2']); ?>" class="form-control" id="kk_2"/>
                                      <?php echo form_error('kk_2'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_3" value="<?php echo ($this->input->post('kf_3') ? $this->input->post('kf_3') : $belanja['kf_3']); ?>" class="form-control" id="kf_3"/>
                                      <?php echo form_error('kf_3'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_3" value="<?php echo ($this->input->post('kk_3') ? $this->input->post('kk_3') : $belanja['kk_3']); ?>" class="form-control" id="kk_3"/>
                                      <?php echo form_error('kk_3'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_4" value="<?php echo ($this->input->post('kf_4') ? $this->input->post('kf_4') : $belanja['kf_4']); ?>" class="form-control" id="kf_4"/>
                                      <?php echo form_error('kf_4'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_4" value="<?php echo ($this->input->post('kk_4') ? $this->input->post('kk_4') : $belanja['kk_4']); ?>" class="form-control" id="kk_4"/>
                                      <?php echo form_error('kk_4'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_5" value="<?php echo ($this->input->post('kf_5') ? $this->input->post('kf_5') : $belanja['kf_5']); ?>" class="form-control" id="kf_5"/>
                                      <?php echo form_error('kf_5'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_5" value="<?php echo ($this->input->post('kk_5') ? $this->input->post('kk_5') : $belanja['kk_5']); ?>" class="form-control" id="kk_5"/>
                                      <?php echo form_error('kk_5'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_6" value="<?php echo ($this->input->post('kf_6') ? $this->input->post('kf_6') : $belanja['kf_6']); ?>" class="form-control" id="kf_6"/>
                                      <?php echo form_error('kf_6'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_6" value="<?php echo ($this->input->post('kk_6') ? $this->input->post('kk_6') : $belanja['kk_6']); ?>" class="form-control" id="kk_6"/>
                                      <?php echo form_error('kk_6'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_7" value="<?php echo ($this->input->post('kf_7') ? $this->input->post('kf_7') : $belanja['kf_7']); ?>" class="form-control" id="kf_7"/>
                                      <?php echo form_error('kf_7'); ?>
                                   </div> <br><br>                     
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_7" value="<?php echo ($this->input->post('kk_7') ? $this->input->post('kk_7') : $belanja['kk_7']); ?>" class="form-control" id="kk_7"/>
                                      <?php echo form_error('kk_7'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_8" value="<?php echo ($this->input->post('kf_8') ? $this->input->post('kf_8') : $belanja['kf_8']); ?>" class="form-control" id="kf_8"/>
                                      <?php echo form_error('kf_8'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_8" value="<?php echo ($this->input->post('kk_8') ? $this->input->post('kk_8') : $belanja['kk_8']); ?>" class="form-control" id="kk_8"/>
                                      <?php echo form_error('kk_8'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_9" value="<?php echo ($this->input->post('kf_9') ? $this->input->post('kf_9') : $belanja['kf_9']); ?>" class="form-control" id="kf_9"/>
                                      <?php echo form_error('kf_9'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_9" value="<?php echo ($this->input->post('kk_9') ? $this->input->post('kk_9') : $belanja['kk_9']); ?>" class="form-control" id="kk_9"/>
                                      <?php echo form_error('kk_9'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_10" value="<?php echo ($this->input->post('kf_10') ? $this->input->post('kf_10') : $belanja['kf_10']); ?>" class="form-control" id="kf_10"/>
                                      <?php echo form_error('kf_10'); ?>
                                   </div> <br><br>                     
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_10" value="<?php echo ($this->input->post('kk_10') ? $this->input->post('kk_10') : $belanja['kk_10']); ?>" class="form-control" id="kk_10"/>
                                      <?php echo form_error('kk_10'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_11" value="<?php echo ($this->input->post('kf_11') ? $this->input->post('kf_11') : $belanja['kf_11']); ?>" class="form-control" id="kf_11"/>
                                      <?php echo form_error('kf_11'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_11" value="<?php echo ($this->input->post('kk_11') ? $this->input->post('kk_11') : $belanja['kk_11']); ?>" class="form-control" id="kk_11"/>
                                      <?php echo form_error('kk_11'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                             ...
                             <div class='panel-body'>
                                <div class="form-group">
                                   <label class="col-md-6 control-label">Kemajuan Fisik (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kf_12" value="<?php echo ($this->input->post('kf_12') ? $this->input->post('kf_12') : $belanja['kf_12']); ?>" class="form-control" id="kf_12"/>
                                      <?php echo form_error('kf_12'); ?>
                                   </div><br><br>                      
                                   <label class="col-md-6 control-label">Kemajuan Keuangan (%):</label>
                                   <div class="col-md-6">
                                      <input type="text" name="kk_12" value="<?php echo ($this->input->post('kk_12') ? $this->input->post('kk_12') : $belanja['kk_12']); ?>" class="form-control" id="kk_12"/>
                                      <?php echo form_error('kk_12'); ?>
                                   </div>
                                </div>
                             </div>
                          </div>
                           ...
                           <div class="col-md-8">
                            ...
                            <div class="attachment-block clearfix">
                              ...
                              Isi isian-isian di bawah ini dan klik tombol "Tambahkan" untuk menambahkan data ke tabel Hasil Pemeriksaan PPHP/PHO di atas: <br><br>       
                                ...
                                <div align="right">
                                    <button type="submit" class="btn" name="tambah_hasil_pemeriksaan">
                                        Tambahkan
                                    </button>                         
                               </div>  
                               <br>
