<div class="row">
    ...
    <div class="box">
	   		<div class='box-header with-border'>
	      		<h4 class="box-title">Edit Program Belanja Langsung</h4>
	      </div><!-- /.box-header -->
	      <div class='box-body'>
            <div class="form-group">
                 <label for="nama_prog" class="col-md-2 control-label">Kode Program</label>
                 <div class="col-md-5">
                     <input type="text" name="kode_prog" value="<?php echo ($this->input->post('kode_prog') ? $this->input->post('kode_prog') : $program['kode_prog']); ?>" class="form-control" id="kode_prog" readonly/>
