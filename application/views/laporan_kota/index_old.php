                ...
                <!-- Small boxes (Stat box) -->
                    <div class="col-md-6">
                      ...
                      <div class="small-box bg-aqua">
                        <div class="inner">
                          <h3><?php echo "Rp. ".number_format($total_kota["anggaran_total"]); ?></h3>
                      ...
                      <div class="small-box bg-blue">
                        <div class="inner">
                          <h3><?php echo "Rp. ".number_format($total_kota["anggaran_bl"]); ?></h3>
                      ...
                      <div class="small-box bg-orange">
                        <div class="inner">
                          <h3><?php echo "Rp. ".number_format($total_kota["anggaran_btl"]); ?></h3>
...
<script>
  ...
  var myPieChartData = {
      datasets: [{
          data: [
            <?php echo number_format(($total_kota["anggaran_bl"] / $total_kota["anggaran_total"]) * 100,2); ?>, 
            <?php echo number_format(($total_kota["anggaran_btl"] / $total_kota["anggaran_total"]) * 100,2); ?>
          ],
