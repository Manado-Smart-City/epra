                          ...
                          <td>
                            <div class="box-pejabat box-widget widget-user-2">
                              ...
                              <div class="widget-user-header">
                                ...
                                <h3 class="widget-user-username"><a href="<?php echo site_url('/laporan_pd/index_metode_pemilihan_penyedia_detail_pptk/'.$tahun_anggaran.'/'.$kode_pd.'/'.$p->nip_pptk)?>"><?php echo $p->nama_p; ?></a></h3>
