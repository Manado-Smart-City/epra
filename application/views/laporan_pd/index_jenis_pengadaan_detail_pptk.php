                      ...
                      <tr>
                          ...
                          <td align="left">
                              <?php 
                                  ...
                                  echo "<h4>Belanja:</h4>";
                                  echo '<a href="'.site_url('laporan_pd/index_jenis_pengadaan_detail_pengadaan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$p->kode_rek_belanja.'">'.$p->kode_rek_belanja."<br>".$p->nama_belanja.'</a> '); 
                          ...
                          <td>
                              <?php 
                                  ...
                                  echo '<a href="'.site_url('laporan_pd/index_jenis_pengadaan_detail_pengadaan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$p->kode_rek_belanja.'">'.$p->nama_paket_pengadaan.'</a> ');
                                  echo "<h4>PPK:</h4>";
                              ?>                             
