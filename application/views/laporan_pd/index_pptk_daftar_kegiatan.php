            ...
            <div class="box box-solid">    
                ...
                <div class="box-body">                
                  ...
                  <div class="col-md-12">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    // echo '<a href="'.site_url('/laporan_pd/index_pptk_detail_kegiatan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$p->kode_giat).'">'.$p->kode_giat."<br>".$p->nama_giat."</a>";                               
                    ...
                    <div class="col-md-12">
                      <br><br>
                      <p align="right"><button type="submit" onclick="window.open('<?php echo site_url('laporan_pd/index_pptk_daftar_kegiatan/2018/'.$pd['kode_pd'].'/'.$laporan_kinerja_pptk_detail->nip_pptk.'/TRUE') ?>');"><img src="<?php echo site_url('resources/img/printer.png');?>" height="20" style="margin-bottom: 5px; margin-top: 5px; margin-right: 5px; "/>Cetak laporan</button></p>
                      <br>
                    </div>
