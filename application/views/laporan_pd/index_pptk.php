        ...
        <div class="box">
            <div class="box box-solid">    
                ...
                <div class="box-body">
                      ...
                      <div class="box-body">
                          ...
                          <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header">
                              ...
                              <h3 class="widget-user-username"><a href="<?php echo site_url('/laporan_pd/index_pptk_daftar_kegiatan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$laporan_kinerja_pptk["tertinggi_fisik"]->nip_pptk)?>"><?php echo $laporan_kinerja_pptk["tertinggi_fisik"]->nama_p; ?></a></h3>
                          ...
                          <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header">
                              ...
                              <h3 class="widget-user-username"><a href="<?php echo site_url('/laporan_pd/index_pptk_daftar_kegiatan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$laporan_kinerja_pptk["tertinggi_keuangan"]->nip_pptk)?>"><?php echo $laporan_kinerja_pptk["tertinggi_keuangan"]->nama_p; ?></a></h3>
                      ...
                      <div class="box-body">
                          ...
                          <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header">
                              ...
                              <h3 class="widget-user-username"><a href="<?php echo site_url('/laporan_pd/index_pptk_daftar_kegiatan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$laporan_kinerja_pptk["terendah_fisik"]->nip_pptk)?>"><?php echo $laporan_kinerja_pptk["terendah_fisik"]->nama_p; ?></a></h3>
                          ...
                          <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header">
                              ...
                              <h3 class="widget-user-username"><a href="<?php echo site_url('/laporan_pd/index_pptk_daftar_kegiatan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$laporan_kinerja_pptk["terendah_keuangan"]->nip_pptk)?>"><?php echo $laporan_kinerja_pptk["terendah_keuangan"]->nama_p; ?></a></h3>
                          ...
                          <td>
                            <div class="box-pejabat box-widget widget-user-2">
                              ...
                              <div class="widget-user-header">
                                ...
                                <h3 class="widget-user-username"><a href="<?php echo site_url('/laporan_pd/index_pptk_daftar_kegiatan/'.$tahun_anggaran.'/'.$kode_pd.'/'.$p->nip_pptk)?>"><?php echo $p->nama_p; ?></a></h3>
                  ...
                  <div class="col-md-12">
                    <br><br>
                    <p align="right"><button type="submit" onclick="window.open('<?php echo site_url('laporan_pd/index_pptk/'.$tahun_anggaran.'/'.$pd['kode_pd'].'/TRUE') ?>');"><img src="<?php echo site_url('resources/img/printer.png');?>" height="20" style="margin-bottom: 5px; margin-top: 5px; margin-right: 5px; "/>Cetak laporan</button></p>
                    <br>
                  </div>
