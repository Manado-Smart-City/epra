			...
			<?php echo form_open('ppk/add',array("class"=>"form-horizontal")); ?>
              	...
              	<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="jabat_ppk" value="<?php echo $this->input->post('jabat_ppk'); ?>" class="form-control" id="jabat_ppk" />
						</div>
					</div>
					<div class="form-group">
						<label for="foto_ppk" class="col-md-4 control-label">Foto Ppk</label>
						<div class="col-md-8">
							<input type="text" name="foto_ppk" value="<?php echo $this->input->post('foto_ppk'); ?>" class="form-control" id="foto_ppk" />
						</div>
					</div>
					<div class="form-group">
