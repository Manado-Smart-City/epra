                      ...
                      <tr>
                          ...
                          <td align="left">
                              <?php 
                                  ...
                                  echo "<h4>Belanja:</h4>";
                                  echo '<a href="'.site_url('laporan/index_metode_pemilihan_penyedia_detail_pengadaan/2017/'.$p->kode_rek_belanja.'">'.$p->kode_rek_belanja."<br>".$p->nama_belanja.'</a> '); 
                          ...
                          <td>
                              <?php 
                                  ...
                                  echo '<a href="'.site_url('laporan/index_metode_pemilihan_penyedia_detail_pengadaan/2017/'.$p->kode_rek_belanja.'">'.$p->nama_paket_pengadaan.'</a> ');
                                  echo "<h4>PPK:</h4>";
                              ?>                             
