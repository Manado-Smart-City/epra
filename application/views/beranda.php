<div class="row">
    <div class="col-md-12">
        <div class="box" style="height: 100%;">
            ...
            <div class="box-body">
                <div class="col-md-12">
            	   <img src="<?php echo site_url('resources/img/banner-epra-baru-red.png'); ?>" width="100%">
                   <br><br>
...
<!--
                    <div class='box-header'>
                      ...
                      <div class='user-block'>
                        ...
                        <span class='username'>Walikota Manado</span>
                      </div>
                    </div> 
-->
                    <div class='box-body'>
                      <!-- post text -->
                      <p>Puji dan syukur kita panjatkan ke hadirat Tuhan Yang Maha Esa atas dibuatnya aplikasi web yang disebut "EPRA" (Evaluasi dan Pengawasan Realisasi Anggaran) Online. Aplikasi ini merupakan aplikasi yang menangani Evaluasi dan Pengawasan Realisasi Anggaran Kota Manado dan dapat diakses di alamat <a href="http://epra.manadokota.go.id">http://epra.manadokota.go.id</a>. Aplikasi EPRA Online ini dimaksudkan sebagai sarana informasi untuk menjawab tuntutan tata kelola kepemerintahan yang baik (good governance) dengan harapan dapat memberikan informasi yang jelas mengenai Penyerapan Anggaran dari setiap Perangkat Daerah (PD) di lingkungan Pemerintah Kota Manado untuk dipergunakan oleh pihak-pihak yang berkepentingan. Selanjutnya, hadirnya aplikasi ini merupakan salah satu langkah strategis dalam mengedepankan transparansi dan akuntabilitas Pemerintah Kota Manado di era informasi dewasa ini. Saya mengharapkan aplikasi ini akan bermanfaat bagi masyarakat luas serta bagi Pemerintah Kota Manado sendiri.</p>
                      <br>
                  <div class="col-md-6">
                         <a href="<?php echo site_url('laporan_kota/index/2023'); ?>"><button class="btn btn-block btn-default btn-lg bg-orange">Laporan Kota</button></a>
                      </div>
                      <div class="col-md-6">
                        <a href="<?php echo site_url('laporan_pd/daftar_pd/2023'); ?>"><button class="btn btn-block btn-default btn-lg bg-olive">Laporan PD</button></a>
                      </div>
