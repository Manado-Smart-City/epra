<div class="row">
    <div class="col-md-12">
      <?php
       ...
       ?>
		<?php echo form_open_multipart('pejabat/add',array("class"=>"form-horizontal")); ?>
		<div class="box">
	      ...
	      <div class='box-body'>
            ...
            <div class="form-group">
                 ...
                 <div class="col-md-5">
                     <input type="text" name="nip_p" value="<?php echo $this->input->post('nip_p'); ?>" class="form-control integer" id="nip_p" placeholder="Wajib diisi dan kode harus unik" />
	        	...
	        	<div class="form-group">
				         ...
				         <div class="col-md-10">
					           <input type="text" name="nama_p" class="form-control" id="nama_p" placeholder="Wajib diisi"/>
            ...
            <div class="form-group">
                 ...
                 <div class="col-md-5">
                     <input type="text" name="jabat_p" class="form-control" id="jabat_p" placeholder="Wajib diisi"/>
            ...
            <div class="form-group">
				         ...
				         <div class="col-md-1">
					           <input type="text" name="urutan_p" value="999" class="form-control integer" id="urutan_p"/>
            ...
            <div class="form-group">
    					...
    					<div class="col-md-10">
    						<input type="text" name="alamat_p" class="form-control" id="alamat_p" />
            ...
            <div class="form-group">
    					...
    					<div class="col-md-5">
    						<input type="text" name="email_p" class="form-control" id="email_p" />
            ...
            <div class="form-group">
    					...
    					<div class="col-md-5">
    						<input type="text" name="hp_p" class="form-control" id="hp_p" />
    					</div>
    				</div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-5">
                <?php echo form_dropdown('kode_pd_asal', $pd,$this->session->userdata['logged_in']['user_pd'],'class="form-control"'); ?>
              </div>
            </div>
            ...
            <div class="form-group">
    					...
    					<div class="col-md-5">
    						<input type="file" name="foto_p" class="form-control" id="foto_p" />
